...
@section('ModuleTitle','category Add')
@section('contentTitle','category')
@section('visiblility','hidden')
@section('content')
<div class="p-3">
    <form class="needs-validation" action="/admin/category" method="post" enctype="multipart/form-data" novalidate>
        {{ csrf_field() }}
        <div class="form-row">
            <div class="col-md-12 mb-3">
                <label for="validationCustom01">Category Name:</label>
                <input type="text" class="form-control form-control-sm" id="validationCustom01" name="category_name" placeholder="Enter Category name" required>
